...
/**
 * Servlet implementation class SelectSemesterForMarksEntry
 */
@WebServlet("/SelectSemesterForMarksEntry")
public class SelectSemesterForMarksEntry extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getSession().getAttribute("userId") != null) {
			...
			request.getRequestDispatcher("enterDetailsForClassPerformanceEntry.jsp").forward(request, response);
		} else {
