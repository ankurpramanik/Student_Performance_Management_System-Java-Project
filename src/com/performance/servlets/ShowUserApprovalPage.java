...
/**
 * Servlet implementation class ShowUserApprovalPage
 */
@WebServlet("/ShowUserApprovalPage")
public class ShowUserApprovalPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getSession().getAttribute("userId") != null) {
			...
			List<UserDto> userList = UserDao.getInactiveUserDetails();
